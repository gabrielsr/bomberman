...
image:https://travis-ci.org/gabrielrs/bomberman.svg?branch=master["Build Status", link="https://travis-ci.org/gabrielrs/bomberman"]
image:http://img.shields.io/coveralls/gabrielrs/bomberman/master.svg["Coverage Status", link="https://coveralls.io/r/gabrielrs/bomberman?branch=master"]
...
Para verificar o status das últimas construções, entre no link: 
	...
	https://travis-ci.org/gabrielrs/bomberman/builds
...
Para ver os resultados dos últimos testes, entre no link:
	...
	https://coveralls.io/r/gabrielrs/bomberman
