...
walkVerticalLineTest:: Testa se a posição da celula do character é atualizada em um movimento por toda a vertical

walkHorizontalLineTest:: Testa se a posição da celula do character é atualizada em um movimento por toda a horizontal
