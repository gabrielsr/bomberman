...
image:https://travis-ci.org/DRA2840/bomberman.svg?branch=master["Build Status", link="https://travis-ci.org/gabrielsr/bomberman"]
image:http://img.shields.io/coveralls/DRA2840/bomberman/master.svg["Coverage Status", link="https://coveralls.io/r/gabrielsr/bomberman?branch=master"]
