...
Ferramentas de análise estática ajudam a encontrar possíveis falhas no código e na documentação, facilitando 
a legibilidade e manutenção do código fonte. 

=== Checkstyle

A ferramenta Checkstyle verifica, dentre outras coisas:
* Comentários Javadoc para classes, atributos e métodos
* Convenções para nomenclatura de atributos e métodos
* Número de parâmetros em funções e comprimento de linhas
* Espaçamento entre caracteres
* Boas práticas para construtores
